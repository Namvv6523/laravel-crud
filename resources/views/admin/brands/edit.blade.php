                                ...
                                <form action="{{ route('admin.brands.update', $brand) }}" method="post"
                                    ...
                                    <div class="mx-auto w-50 mt-3">
                                        ...
                                        <select name="is_show" id="is_show" class="form-control">
                                            <option @if ($brand->is_show) selected @endif value="1">Show
                                            </option>
                                            <option @if ($brand->is_show) selected @endif value="0">Hide
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-center mt-3">
                                        ...
                                        <a href="{{ route('admin.brands.index') }}" class="btn btn-warning me-2">Back to list</a>
